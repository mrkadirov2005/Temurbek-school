	...
	return (
		...
		>
			...
			<motion.div id="header_links" className={"flex items-center nav_links justify-between w-4/5 "}>
				...
				<Link onClick={() => handleToglePie()} className="w-full" href="/courses">
					<motion.div className="link_item w-full" variants={linkVariants} whileHover="hover">
						Kurslar
					</motion.div>
				</Link>
				<Link onClick={() => handleToglePie()} className="w-full" href="/events">
					<motion.div className="link_item w-full" variants={linkVariants} whileHover="hover">
						Tadbirlar
					</motion.div>
				</Link>
				<Link onClick={() => handleToglePie()} className="w-full" href="/mocks">
					<motion.div className="link_item w-full" variants={linkVariants} whileHover="hover">
						Mock imtihonlar
					</motion.div>
				</Link>
